...
DESCRIPTIONS = {
    ...
    "02-ai-workloads/transformer.md": "Transformer 流程、Q/K/V、训练与推理差异、KV Cache 和系统影响。",
    "02-ai-workloads/training-primer.md": "训练过程、loss、backward、optimizer 和系统资源压力。",
    "02-ai-workloads/inference-primer.md": "推理过程、prefill、decode、sampling 和服务阶段差异。",
    "02-ai-workloads/data-paths.md": "数据、token、batch shape、sequence length 和输入路径。",
