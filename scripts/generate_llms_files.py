...
DESCRIPTIONS = {
    ...
    "04-training-systems/index.md": "训练系统与优化主题入口，覆盖训练生命周期、数据混合采样、大词表输出层/loss、backward/autograd、collective 通信原语、并行策略、通信重叠、FLUX、参数高效微调、后训练工作负载、Muon 优化器、evaluation/checkpoint selection、checkpoint 和训练 benchmark。",
