...
DESCRIPTIONS = {
    ...
    "12-hardware-basics/npu-basics.md": "NPU 基础概念结合 Ascend/CANN 官方与准官方架构图解释 NPU 执行模型、AI Core、Cube、Vector、Scalar、MTE/DataCopy、Local Memory、Global Memory/HBM、UB、L1、L0A/L0B/L0C、Cube 计算单元、UB 存储结构、Tiling、TPipe/TQue、GlobalTensor/LocalTensor、SIMD/SIMT/RegBase、compiler、runtime、profiling、AI workload 映射和 NPU 实验最小记录清单。",
