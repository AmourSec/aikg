...
DESCRIPTIONS = {
    ...
    "12-hardware-basics/ascend-910-series.md": "Ascend 910 系列平台要点说明 910、910B、910_93 在服务器训练、推理、算子和编译优化中的学习重点、实验清单和 CANN 上下文记录方式。",
    "12-hardware-basics/ascend-950-series.md": "Ascend 950 系列平台要点说明 950PR、950DT、DAV_3510、Atlas 950/A5 的公开线索、验证边界、Prefill/Decode、低精度、通信扩展和 skill 沉淀方向。",
