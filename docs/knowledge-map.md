...
| 想让 AI 复用团队工作流程 | [AI Skills 编写指南](11-knowledge-index/skills-authoring-guide.md) -> [硬件适配 AI Skills 样例](12-hardware-basics/ai-skills-sample.md) -> [知识组织、模板与 AI 可读索引](11-knowledge-index/index.md) |
