  ...
  <div class="kg-mindmap-branches">
    ...
    <section class="kg-mindmap-branch">
      ...
      <ul>
        ...
        <li class="kg-node-note"><span>关键词：profiling / roofline / capacity / signals / incidents</span></li>
      </ul>
    </section>
    <section class="kg-mindmap-branch">
...
| 9 可靠性、可观测性与故障复盘 | 3、4、7、8 | 监控、告警、metrics/logs/traces/profiles/events、故障模式、复盘和改进项 |
